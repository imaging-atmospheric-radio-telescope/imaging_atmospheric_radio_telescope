...
astra2e_wavelength_m = speed_of_light_m_per_s / astra2e_local_oscillator_frequency_Hz
astra2e_antenna_effective_area_m2 = (astra2e_wavelength_m ** 2) / (4.0 * np.pi)

astra2e_spots_m2 = {}
astra2e_spots_m2["kaband"] = (np.pi/4) * 3236e3 * 1640e3 # from astra2e_kaband.svg
astra2e_spots_m2["efg-pe"] = (np.pi/4) * 3569e3 * 2890e3 # from astra2e_efg-pe.svg
astra2e_spots_m2["me"] = (np.pi/4) * 3980e3 * 3543e3 # from astra2e_me.svg
astra2e_spots_m2["efg-ukspot"] = (np.pi/4) * 2024e3 * 1415e3 # from astra2efg-ukspot.svg
