...
out_path = os.path.join(
    "/", "lfs", "l8", "hin", "relleums", "iaat_instrument_response"
)
...
image_sensor_distance = 1.0 / (
    1.0 / imaging_reflector_config["focal_length"] - 1.0 / OBJECT_DISTANCE
)
